...
#pragma warning disable CS0612
            ...
            {
                TooltipText = "单击以在默认浏览器中打开Ryujinx网站.",
                Justify     = Justification.Center,
                Attributes  = new AttrList()
            };
            ...
            // _disclaimerLabel
            //
            _disclaimerLabel = new Label("Ryujinx不隶属于Nintendo™,\n或其任何合作伙伴，以任何方式.")
            {
                Expand     = true,
                Justify    = Justification.Center,
                Margin     = 5,
            ...
            // _amiiboApiLinkLabel
            //
            _amiiboApiLinkLabel = new Label("AmiiboAPI（www.AmiiboAPI.com）用于Amiibo仿真.")
            {
                TooltipText = "单击以在默认浏览器中打开AmiiboAPI网站。",
                Justify     = Justification.Center,
                Attributes  = new AttrList()
            };
            ...
            {
                TooltipText = "单击以在默认浏览器中打开Ryujinx Patreon页面."
            };
            ...
            {
                TooltipText = "单击以在默认浏览器中打开Ryujinx GitHub页面."
            };
            ...
            {
                TooltipText = "单击以在默认浏览器中打开对Ryujinx Discord服务器的邀请."
            };
            ...
            {
                TooltipText = "单击以在默认浏览器中打开Ryujinx推特页面。"
            };
            ...
            //
            _aboutDescriptionLabel = new Label("Ryujinx是任天堂Switch™的模拟器.\n" +
                                               "请在Patreon上支持我们.\n" +
                                               "在我们的推特或Discord上获取所有最新消息.\n" +
                                               "有兴趣贡献的开发者可以在我们的GitHub或Discord上了解更多信息.")
            {
                Margin = 15,
                Halign = Align.Start
            };
            ...
            // _createdByLabel
            //
            _createdByLabel = new Label("维护人员 :")
            {
                Halign     = Align.Start,
                Attributes = new AttrList()
            };
            ...
            //
            _contributorsLinkLabel = new Label("查看所有参与者...")
            {
                TooltipText = "单击以在默认浏览器中打开“参与者”页面.",
                MarginRight = 30,
                Halign      = Align.End,
                Attributes  = new AttrList()
            };
